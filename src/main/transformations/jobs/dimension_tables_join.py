...
def dimensions_table_join(final_df_to_process,
    ...
    ## here you dropping the "s3_data.customer_id" column but it didn't work through aliasing
    ## so use select statment to ignore this column

    logger.info("Schema of the final_df_to_process with customer_table_df ")
