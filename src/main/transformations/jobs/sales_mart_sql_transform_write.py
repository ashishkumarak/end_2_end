...
# find out the sales_person total purchase every month
...
def sales_mart_calculation_table_write(final_sales_team_data_mart_df):
    ...
    # Write the Data into MySQL sales_team data mart table
    print("writing the data into sales_team data mart table in Database")
